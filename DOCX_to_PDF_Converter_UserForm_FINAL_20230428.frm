VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} DOCX_to_PDF_Converter_UserForm 
   Caption         =   "DOCX to PDF Batch Converter"
   ClientHeight    =   2760
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   9210
   OleObjectBlob   =   "DOCX_to_PDF_Converter_UserForm_FINAL_20230428.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "DOCX_to_PDF_Converter_UserForm"
